...
public class Account {
	private double total_balance=20000;
	...
	public static void main(String[] args) {
		...
		System.out.println(" Amount after Withdrawl is : "+a.withdrawl(2000));
		System.out.println("Available balance in accout is : " +a.checkBalance());
		System.out.println(" Amount after deposite is  : "+a.deposite(25000));
